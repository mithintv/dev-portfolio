...
const Card = () => {
  ...
  return (
    <div className='card'>
      <img src='https://wp.regaltheme.com/mim/wp-content/uploads/2017/06/portfolio-5-1.jpg' />
      <div className='card-content'>
        <div className='card-header'>
          <h4>Wordle Leaderboard</h4>
          <div className='card-icons'>
            <a href='https://github.com/mithin888/wordle-tracker'><i class="fa-brands fa-github"></i></a>
